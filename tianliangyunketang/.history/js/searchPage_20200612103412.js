...
var page_ = 1;
function seekContent(y, id = "", cost = "") {
    var searchData = {
        pageNum: y,
        pageSize: 10,
    };
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            /* 图片数据 */
            var courseBoxFree = '<li><a href="#"><div class="imgBox"><img src=""></div><p class="bt"> web前端基础之html+css </p><p class="course">共<span class="dsJK"> 56 </span>节课 | <span class="dsR"></span> 人报名</p><p class="free">免费</p></a></li>';
            var courseBoxBoutique = '<li><a href="#"><div class="imgBox"><img src=""></div><p class="bt"> web前端基础之html+css </p><p class="course">共<span class="dsJK"> 56 </span>节课 | <span class="dsR">147</span> 人报名</p> <p class="charge">￥99.9 <del> ￥&nbsp;800</del></p><div class="xsjh pull-right">限时钜惠</div></a></li>';
            ...
            $('#nextPage_').click(function () {
                if (page_ < pageCount) {
                    ...
                    page_ += 1;
                    seekContent( page_, localStorage.pageId, localStorage.Class)
                } else {
            ...
            $('.pagingLi').click(function () {
                ...
                seekContent( $(this).html(), localStorage.pageId, localStorage.Class);
            })
...
$.ajax({
    ...
    success: function (res) {
        ...
        //         $(this).addClass('active').siblings().removeClass('active');
        //         seekContent( page_, $(this).attr('name'));
        //     }
        // });
