...
function veiwMain(keyword, pageNum, subjectId = "", type = "") {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            /* 图片数据 */
            var courseBoxFree = '<li><a href="#"><div class="imgBox"><img src=""></div><p class="bt">  </p><p class="course">共<span class="dsJK"> 56 </span>节课 | <span class="dsR"></span> 人报名</p><p class="free"></p></a></li>';
            var courseBoxBoutique = '<li><a href="#"><div class="imgBox"><img src=""></div><p class="bt">  </p><p class="course">共<span class="dsJK"> 56 </span>节课 | <span class="dsR">147</span> 人报名</p> <p class="charge">￥99.9 <del> ￥&nbsp;800</del></p><div class="xsjh pull-right"></div></a></li>';
