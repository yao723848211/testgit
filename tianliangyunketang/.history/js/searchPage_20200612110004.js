...
function veiwMain(keyword, pageNum, subjectId = "", type = "") {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            /* 图片数据 */
            var courseBoxFree = '<li><a href="#"><div class="imgBox"><img src=""></div><p class="bt">  </p><p class="course">共<span class=""> 56 </span>节课 | <span class="dsR"></span> 人报名</p><p class="free">免费</p></a></li>';
            var courseBoxBoutique = '<li><a href="#"><div class="imgBox"><img src=""></div><p class="bt">  </p><p class="course">共<span class=""> 56 </span>节课 | <span class="dsR">147</span> 人报名</p> <p class="charge">￥99.9 <del> ￥&nbsp;800</del></p><div class=" pull-right">限时钜惠</div></a></li>';
            ...
            $('#nextPage_').click(function () {
                if (page_ < pageCount) {
                    ...
                    page_ += 1;
                    veiwMain( page_, localStorage.pageId, localStorage.Class)
                } else {
            ...
            $('.pagingLi').click(function () {
                ...
                veiwMain( $(this).html(), localStorage.pageId, localStorage.Class);
            })
