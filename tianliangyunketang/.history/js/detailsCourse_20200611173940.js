...
/* 评论 */
/* 大盒子 */
var plBOx = '<div class="message clearfix"><div class="pull-left"><span class="userimg"><img src="user.png"></span><span class="userName"></span></div><ul class="pull-right"><li class="lipl"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-wujiaoxing-"></use></svg></li><li class="lipl"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-wujiaoxing-"></use></svg></li><li class="lipl"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-wujiaoxing-"></use></svg></li><li class="lipl"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-wujiaoxing-"></use></svg></li><li class="lipl"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-wujiaoxing-"></use></svg></li></ul></div>'
