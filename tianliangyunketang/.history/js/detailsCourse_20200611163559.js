...
var iconfont = '<div class="pull-right rightBox"><span class="tubiao"><i style="font-size:16px;margin:0 10px 0 0;"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-bofang"></use></svg></i></span><span class="watch">观看</span></div>';
// 子章节的盒子
/* 课程盒子 */
