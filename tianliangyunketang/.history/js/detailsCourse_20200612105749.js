...
// 课程描述
$.ajax({
    url: 'http://59.111.104.104:8086/pc/course/detail/' + localStorage.courseId ,
    type: 'get',
...
var userText = '<p class="userText"></p>';
var userTime = '<p class="userTime"></p>';

$.ajax({
    url: 'http://59.111.104.104:8086/pc/comment/commentList/course/' + localStorage.courseId,
    contentType: "application/json;charset=UTF-8",
    type: 'get',
    success: function (res) {
        ...
        for (var i = 0; i < res.rows.length; i++) {
            ...
            $('#userplBox').append('<div class="userpl clearfix">' + plBOx + userText + userTime + '</div>');
            /* 评论内容 */
