...
var page_ = 1;
function seekContent(keyword, pageNum, subjectId = "", cost = "") {
    var searchData = {
        pageNum: pageNum,
        pageSize: 10,
    };
        ...
        success: function (res) {
            ...
            $('#nextPage_').click(function () {
                if (page_ < pageCount) {
                    ...
                    page_ += 1;
                    seekContent(localStorage.keyword, page_, localStorage.pageId, localStorage.Class)
                } else {
    ...
    success: function (res) {
        ...
        $('.midBox1 span').each(function () {
            ...
            if ($(this).html() == localStorage.course) {
                $(this).addClass('active').siblings().removeClass('active');
                seekContent(localStorage.keyword, page_, $(this).attr('name'));
            }
        });
