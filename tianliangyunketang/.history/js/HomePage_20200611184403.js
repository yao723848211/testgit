...
$.ajax({
    ...
    success: function (res) {
        ...
        for (let i = 0; i < free.length; i++) {
            ...
            // console.log($(".free")[i].getAttribute("name1"))
            // console.log($(".free")[i])
...
$.ajax({
    ...
    success: function (res) {
        ...
        for (let i = 0; i < boutique.length; i++) {
            ...
            boutique[i].onclick = function(){
                // console.log(free[i].getAttribute("name1"))
                localStorage.setItem("courseId",boutique[i].getAttribute("name1"))
                // console.log(localStorage.getItem("courseId"))
                console.log(localStorage.courseId)
                location.href = "detailsCourse.html"
            } 
    ...
    success: function (res) {
        ...
        for (let i = 0; i < boutique.length; i++) {
            ...
            discount[i].onclick = function(){
                // console.log(free[i].getAttribute("name1"))
                localStorage.setItem("courseId",discount[i].getAttribute("name1"))
                // console.log(localStorage.getItem("courseId"))
                console.log(localStorage.courseId)
                location.href = "detailsCourse.html"
            } 
