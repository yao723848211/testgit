    ...
    success: function (res) {
        ...
        for (let i = 0; i < boutique.length; i++) {
            ...
            if (res.rows[i].isFree == 1) {
                ...
                // $(".boutique .span4").text(res.rows[i].coursePrice)
                $(".boutique").find(".span4")[i].innerText = res.rows[i].coursePrice;
                // $(".boutique .span5").text(res.rows[i].discountPrice)
                $(".boutique").find(".span5")[i].innerText = res.rows[i].discountPrice
