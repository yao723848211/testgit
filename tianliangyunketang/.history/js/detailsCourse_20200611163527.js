...
var iconfont = '<div class="pull-right rightBox"><span class="tubiao"><i><svg class="icon" aria-hidden="true"><use xlink:href="#icon-bofang"></use></svg></i></span><span class="watch">观看</span></div>';
// 子章节的盒子
/* 课程盒子 */
